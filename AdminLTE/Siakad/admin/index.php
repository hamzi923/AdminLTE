  ...
  <body class="sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
            ...
            <li class="nav-item dropdown user-menu">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  <p>
                    Administrator
                    <small>UIN Prof. K.H. Saifuddin Zuhri</small>
                  </p>
                </li>
                <!--end::User Image-->
                <!--begin::Menu Footer-->
                <li class="user-footer">
                  <a href="./?p=ganti_pw" class="btn btn-default btn-flat">Ganti Password</a>
      ...
      <aside class="app-sidebar bg-primary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="../index.html" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-dark">UIN SAIZU</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="./?p=ganti_pw" class="nav-link">
                  <i class="nav-icon bi bi-circle-fill"></i>
                  <p>Ganti Password</p>
                </a>
              </li>
      ...
      <footer class="app-footer">
        ...
        <strong>
          Copyright &copy; 2025&nbsp;
          <a href="https://adminlte.io" class="text-decoration-none">Siakad UIN Saizu💔💔💔</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
